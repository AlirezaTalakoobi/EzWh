...
describe("test insert item api", () => {
  ...
  deleteAllData(204);
  newSKUItem(200, "12345678909876543212345678909876", 4, "2020/11/03");
  newSKUItem(404, "12345678909876543212345678909876", 8888, "2020/11/03");
  newSKUItem(409, "12345678909876543212345678909876", 4, "2020/11/03");
});
...
describe("test get items api", () => {
  ...
  deleteAllData(204);
  newSKUItem(200, "12345678909876543212345678909876", 4, "2020/11/03");
  getSKUITEMS(200, "12345678909876543212345678909876", 4, 0, "2020/11/03");
});
...
describe("test get item api", () => {
  ...
  getSKUItemByRFID(200, "12345678909876543212345678909876", 4, 0, "2020/11/03");
