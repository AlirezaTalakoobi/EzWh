...
function clearall() {
  agent.delete("/api/deleteAllTests").then(function (res) {
...
function get_normal(expectedHTTPStatus, rfid) {
  it("get items", function (done) {
    agent
      .get("/api/skuitems/" + rfid.toString() + "/testResults")
      .send()
      .then(function (res) {
...
function get_id(expectedHTTPStatus, rfid, id) {
  it("get test", function (done) {
    agent
      .get("/api/skuitems/" + rfid.toString() + "/testResults", id)
      .send()
      .then(function (res) {
        res.should.have.status(expectedHTTPStatus);
        done();
...
function modify_item(expectedHTTPStatus, rfid, id, newid, date, result) {
  it("modify items", function (done) {
    agent
      .put("/api/skuitems/" + rfid.toString() + "/testResult", id)
      .send({
...
function delete_id(expectedHTTPStatus, rfid, id) {
  it("delete items", function (done) {
    agent
      .delete("/api/skuitems/" + rfid + "/testResult/", id.toString())
      .send()
      .then(function (res) {
